        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-gray-400 mb-8">
              SmartDeeds membership tiers provide exclusive access to this
              iconic property through blockchain-secured membership passes. Each
              tier offers different levels of access and benefits related to
              Project Malibu.
            </p>
