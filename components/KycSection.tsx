...
/**
 * Inline KYC Section Component
 * 
 * This component displays the KYC verification prompt inline on the main page
 * instead of redirecting to a separate page. It replaces the NFTTiers section
 * when KYC is enabled but the user is not yet verified.
 */
export default function KycSection() {
  ...
  return (
    <section id="kyc-section" className="py-20 md:py-24 bg-black relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <motion.div variants={fadeInUp} className="flex flex-col items-center gap-3 mb-6">
            ...
            <Badge
              variant="outline"
              className="border-yellowish/50 text-yellowish bg-yellowish/10 px-4 py-2 text-base"
            >
              Secure Verification
            </Badge>
          ...
          >
            ...
            <span className="text-yellowish">Required</span>
          </motion.h2>
          ...
          >
            Complete KYC verification to access membership vouchers. This is a quick and secure
        ...
        >
          <Card className="bg-zinc-950 border-white/10 max-w-3xl mx-auto">
            <CardHeader className="text-center">
              <CardTitle className="text-2xl text-white">
                Begin Verification Process
              </CardTitle>
              <CardDescription className="text-gray-400 text-base">
                You'll be redirected to our secure verification partner. The process typically
                takes 2-3 minutes.
              </CardDescription>
            </CardHeader>
              ...
              <div className="space-y-3 text-gray-300">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm">
                      Have your government-issued ID ready (passport, driver's license, or national
                      ID)
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm">
                      Follow the secure verification flow to submit your information
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm">
                      You'll be automatically redirected back once verification is complete
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-6 border-t border-white/10 space-y-4">
                ...
                <div className="bg-yellowish/5 border border-yellowish/20 rounded-lg p-4">
                  <p className="text-xs text-gray-300 leading-relaxed">
                    <strong className="text-yellowish">Your privacy is protected:</strong> SmartDeeds
                    and SolsLot do not have access to any of your KYC information. We only receive a
                    pass or fail result to grant access. Your verification session is stored locally
                    on your device—if you visit from a new device, you may be asked to verify again.
                  </p>
                </div>
              </div>
            </CardContent>
